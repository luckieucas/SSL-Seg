...
parser.add_argument('--exp', type=str,
                    default='MMWHS_URPC', help='experiment_name')
...
parser.add_argument('--gpu', default='5,6', type=str, help='id(s) for CUDA_VISIBLE_DEVICES')
...
def train(args, snapshot_path):
    ...
    wandb.init(project="semi-supervised-segmentation", name="{}_{}_labeled{}".format(args.exp,args.model,args.labeled_num),
                config=args)
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > args.began_eval_iter and iter_num % 200 == 0:
                ...
                if args.dataset == 'BCV':
                    ...
                    test_list=test_list,
                    num_classes=num_classes, patch_size=args.patch_size,stride_xy=64, stride_z=64,method='urpc')
                else:
...
if __name__ == "__main__":
    ...
    snapshot_path = "../model/{}_{}_{}_URPC/{}".format(
