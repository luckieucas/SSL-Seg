...
from datasets.dataset import get_train_loaders
...
def _create_trainer(config, model, optimizer, lr_scheduler, loss_criterion, eval_criterion, loaders, wandb=None):
...
class UNet3DTrainerBuilder:
    ...
    def build(config, wandb=None):
        ...
        trainer = _create_trainer(config, wandb=wandb, model=model, optimizer=optimizer, lr_scheduler=lr_scheduler,
...
class UNet3DTrainer:
    ...
    def __init__(self, model, optimizer, lr_scheduler, loss_criterion,
                 ...
                 skip_train_validation=False,wandb=None, **kwargs):
    ...
    def from_checkpoint(cls, resume, model, optimizer, lr_scheduler, loss_criterion, eval_criterion, loaders,
                        tensorboard_formatter=None, sample_plotter=None, wandb=None, **kwargs):
    ...
    def train(self):
        ...
        for t in self.loaders['train']:
            ...
            self.wandb.log({"iteration":self.num_iterations,"epoch:":self.num_epoch,"dice loss": loss.item()})
    ...
    def validate(self):
        ...
        with torch.no_grad():
            ...
            self.wandb.log({"val loss":val_losses.avg,"val dice": val_scores.avg})
