...
parser.add_argument('--exp', type=str,
                    default='MMWHS_Entropy_Minimization', help='experiment_name')
...
parser.add_argument('--gpu', default='2', type=str, help='id(s) for CUDA_VISIBLE_DEVICES')
...
def train_EM(args, snapshot_path):
    exp = config['exp']
